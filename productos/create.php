                    ...
                    <div class="card card-outline card-warning">
                        ...
                        <div class="card-body">
                            ...
                            <form action="../App/controllers/productos/create_productos.php" method="post"  enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="id_productos" name="id_productos" placeholder="Ingrese codigo del producto" required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="stock_min" name="stock_min" placeholder="Ingrese cantidad minima de stock" required>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="stock_max">Stock maximo:</label>
                                                <input type="number" class="form-control" id="stock_max" name="stock_max" placeholder="Ingrese cantidad maxima de stock" required>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="file" class="form-control" id="file" name="imagen" required>
                                ...
                                <button type="submit" class="btn btn-sm btn-warning" id="submit-btn">Agregar producto</button>
                            </form>
                        </div>
                        <!-- /.card-body -->
                    </div>
